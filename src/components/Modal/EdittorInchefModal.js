...
const EdittorInchefModal = ({ id,load,setLoad }) => {
  ...
  return (
    <div>
      ...
      <ModalFooter>
        <Button2 onClick={() => onSubmit("public")} disabled={isLoading}>
          {isLoading ? "Deleting..." : "Công Khai"}
        </Button2>
        <Button1 onClick={() => onSubmit("restricted")} disabled={isLoading}>
          {isLoading ? "Deleting..." : "Hạn Chế"}
        </Button1>
...
export default EdittorInchefModal;
